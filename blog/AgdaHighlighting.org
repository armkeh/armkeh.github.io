...
#+Property: header-args:emacs-lisp :tangle artifacts/AgdaHighlighting.el
...
The code described below is collected into a [[./artifacts/AgdaHighlighting.el][raw Elisp file]],
