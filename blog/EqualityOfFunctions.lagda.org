...
#+Property: header-args:agda2 :tangle artifacts/EqualityOfFunctions.agda
...
A raw Agda source file containing all the code below can be found [[file:artifacts/EqualityOfFunctions.agda][here]].
