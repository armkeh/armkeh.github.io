...
* Portfolio
:PROPERTIES:
:CUSTOM_ID: org-anchor-Portfolio^1
:END:

** Open source projects/contributions
:PROPERTIES:
:CUSTOM_ID: org-anchor-Open-source-projects/contributions^1
:END:

|----------------------------------------+---------------------------------------------------------------------------------------------------|
| Project                                | Contributions                                                                                     |
|----------------------------------------+---------------------------------------------------------------------------------------------------|
| Ansible [[https://github.com/ansible-collections/community.general][community.general]] collection   | PR [[https://github.com/ansible-collections/community.general/pull/9494][#9494]]: Keycloak modules retry request on authentication error, support refresh token parameter |
|----------------------------------------+---------------------------------------------------------------------------------------------------|
| Emacs package [[https://github.com/armkeh/consistent-window-splits/][consistent-window-splits]] | Creator, sole contributor                                                                         |
|----------------------------------------+---------------------------------------------------------------------------------------------------|
